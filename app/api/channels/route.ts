...
import type { GET as G, POST as P } from "@/lib/server/types";
import { deleteChannel, postChannel } from "@/lib/server/zod";
import { createId } from "@paralleldrive/cuid2";
import { eq } from "drizzle-orm";
import { NextResponse } from "next/server";

export const GET = handler<G["/api/channels"]["data"]>(async () => {
...
export const POST = handler<P["/api/channels"]["data"]>(async (req) => {
